    ...
    return (
        <Card>
            <CardActionArea>
                ...
                <CardContent>
                    <Typography varient="body2" color="textSecondary" component="p"></Typography>
                </CardContent>
            </CardActionArea>
            <CardActions>
